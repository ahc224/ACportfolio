...
> The infographic below lists some of the statistics behind the party culture at Lehigh University, and where certain students have parties in relation to its location. The infographic compares whether the individual is male or female, to which parties the individual attends, and where the individual prefers to have or host a party, whether it is on or off campus, and off or on the hill. Tableau does a good job visualizing this because the user is able to hover the mouse over a certain bar on the graph in order to find out more about the statistic, making the data more accessible and readable without it being too culttered up. The addition of multiple axes and a legend dependent on color also help make the data more accessible, all of it relying on a single variable, that being the percentage of overall students at Lehigh. There is a distinct correlation between amount of students who want to attend the party and its location. This way, all of the information that is taken from a long and complicated survey can be easily accessed in a visualizaed format.
